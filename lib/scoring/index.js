 ...
 * Version: 2.2.0
 * Changes: Adjusted thresholds to 75%/40% for better user experience
 */
...
function levelFromPct(pct) {
  if (pct >= 75) return 'Core Focus';
  if (pct >= 40) return 'Strategic Secondary';
  return 'Noise';
}
